...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      <h1 className='text-3xl font-bold mb-4 text-slate-800'>Welcome to RooMoo – Your Gateway to Seamless Living in Nanded City!</h1>
      <p className='mb-4 text-slate-700'>Discover a world of convenience and comfort with RooMoo, your go-to platform for renting rooms, flats, and houses in the vibrant city of Nanded. Our mission is to simplify the process of finding the perfect living space, making it easier for you to find a home that suits your lifestyle.
</p>
      <p className='mb-4 text-slate-700'>
      At RooMoo, we understand that the right living space can make all the difference. Whether you're a student, a professional, or a family looking for a cozy nest, we've got you covered. Our user-friendly website connects landlords and tenants, creating a harmonious space for everyone involved.
      </p>
      <div>
...
<h5 className='mb-4 mt-5 font-bold text-slate-700'>Experience the joy of hassle-free living by choosing RooMoo as your trusted partner in the Nanded City rental market. Join our community today and embark on a journey to find the perfect home that complements your lifestyle.</h5>
      ...
      <p className='mb-4 text-slate-700 font-serif'>RooMoo - Where Comfort Meets Convenience in Nanded City!</p>
    </div>
  )
}
