    ...
    <section>
      <div className="flex items-center justify-center space-x-1 lg:space-x-40 max-w-6xl mx-auto">
        ...
        <form onSubmit={onSubmit}>
          <div className="bg-[#F0FDF4] flex flex-col  border-[3px] mt-9 my-2 sm:w-[400px] lg:w-[500px] rounded-[0.6rem] shadow-lg h-[330px] ">
            ...
            <div className="flex justify-between mx-3 mt-8 lg:text-[15px]  text-[13px] ">
              <p>
            ...
            <div className="flex justify-center flex-col m-2 gap-3 flex-wrap">
              <button
                className=" text-white font-medium uppercase bg-blue-600 p-3 rounded-lg shadow-sm hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800
        "
                type="submit"
              >
                Send reset password
