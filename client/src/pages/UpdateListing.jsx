            ...
            <div className="flex flex-col flex-1 gap-4">
              ...
              <div className="flex gap-4">
                <input
                  ...
                  className="p-3 border-[1px] border-gray-400 rounded w-full"
                  type="file"
                  id="images"
                  accept="image/*"
                  multiple
              ...
              {formData.imageUrls.length > 0 &&
                formData.imageUrls.map((url, index) => (
                  <div
                    key={url}
                    className="flex justify-between p-3 border-[1px] border-gray-400 items-center"
                  >
                    <img
                      src={url}
                      alt="listing image"
              ...
              <button
                ...
                className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 hover:bg-slate-800 after:bg-slate-900 disabled:opacity-80"
              >
                {loading ? "Uploading..." : "Edit property"}
              </button>
